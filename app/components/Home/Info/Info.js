      ...
      <div className={styles.container}>
        ...
        <div className={styles.flexContainer}>
          <div className={styles.featureContainer}>
            <Image src={addFiles} height={125} width={125} />
          ...
          <div className={styles.featureContainer}>
            <Image src={organizeFiles} height={125} width={125} />
            <p className={styles.title}>Organized Workspace</p>
            <p className={styles.description}>Keep related files together and locate files quickly through our search tool.</p>
          </div>
          <div className={styles.featureContainer}>
            <Image src={secureFiles} height={125} width={125} />
            <p className={styles.title}>Secured Files</p>
